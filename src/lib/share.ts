 ...
 */
export function encodePuzzle(board: any[][], difficulty?: string, completionTime?: number, colorKuMode?: boolean): string {
 ...
 */
export function generateShareText(completionTime?: number, difficulty?: string): string {
	if (completionTime) {
